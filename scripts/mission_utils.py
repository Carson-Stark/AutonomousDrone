...
class MissionItem:
    ...
    def __init__(self, command_type, target, title, speed=3, timeout=-1, obj_search=False, lnd_search=False):
    ...
    def add_commands(self, vehicle):
        if self.command == CommandType.WAYPOINT or self.command == CommandType.SEARCH:
